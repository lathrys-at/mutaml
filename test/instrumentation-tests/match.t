...
----------------------------------------------------
  ...
  let () =
    ((match !Sys.interactive with
      | false when
          not (__is_mutaml_mutant__ "test.ml:toplevel:merge-cases:fc25263d:0")
  ...
  $ MUTAML_MUTANT="test.ml:toplevel:merge-cases:fc25263d:0" dune exec --no-build ./test.bc
...
----------------------------------------------------
  ...
  ----------------------
   ...
   ---------------------------------------------------------------------------------------------------
   test.ml                                2       0.0%    0     0.0%    0   100.0%    2             0
   ===================================================================================================
...
Instead we trigger the collapse-consecutive-patterns mutation:
  ...
  ----------------------
   ...
   target                          #mutations      #failed      #timeouts      #passed       #not run
   ---------------------------------------------------------------------------------------------------
   test.ml                               13       0.0%    0     0.0%    0   100.0%   13             0
   ===================================================================================================
...
--------------------------------------------------------------------------------
  ...
  ----------------------
   ...
   target                          #mutations      #failed      #timeouts      #passed       #not run
   ---------------------------------------------------------------------------------------------------
   test.ml                                5       0.0%    0     0.0%    0   100.0%    5             0
   ===================================================================================================
...
--------------------------------------------------------------------------------
  ...
  let rec interpret xval ae =
    ((match ae with
      ...
      | Binop (ae0, Add, ae1) when
          not (__is_mutaml_mutant__ "test.ml:interpret:merge-cases:0d7e7164:0")
          ->
          let v0 = interpret xval ae0 in
          let v1 = interpret xval ae1 in
          if __is_mutaml_mutant__ "test.ml:interpret:arith-operator:6464eb37:0"
  ...
  ----------------------
   ...
   target                          #mutations      #failed      #timeouts      #passed       #not run
   ---------------------------------------------------------------------------------------------------
   test.ml                                6       0.0%    0     0.0%    0   100.0%    6             0
   ===================================================================================================
...
--------------------------------------------------------------------------------
  ...
  $ head -n 4 output.txt && echo "ERROR MESSAGE" && tail -n 41 output.txt
  Running mutaml instrumentation on "test.ml"
  Randomness seed: 896745231   Mutation rate: 100   GADTs enabled: true
  Created 6 mutations of test.ml
  Writing mutation info to test.muts
  ...
  let _f x =
    ...
    | [|_;_;_|] ->
        if __is_mutaml_mutant__ "test.ml:_f:int-constant:3f492773:0"
        then 4
        else 3
    | _ when
        if __is_mutaml_mutant__ "test.ml:_f:bool-constant:5bf88c8b:0"
        then false
        else true ->
        if __is_mutaml_mutant__ "test.ml:_f:int-constant:72a35376:0"
        then 1001
        else 1000
...
--------------------------------------------------------------------------------
  ...
  let _f x =
    ((match x with
      | [||] when
          not (__is_mutaml_mutant__ "test.ml:_f:merge-cases:63585d72:0") ->
          if __is_mutaml_mutant__ "test.ml:_f:int-constant:92be9951:0"
          then 1
          else 0
      | [||] | [|_|] when
          not (__is_mutaml_mutant__ "test.ml:_f:merge-cases:64c7b2e6:0") ->
          if __is_mutaml_mutant__ "test.ml:_f:int-constant:50c5a5ff:0"
          then 0
          else 1
      | [|_|] | [|_;_|] when
          not (__is_mutaml_mutant__ "test.ml:_f:merge-cases:8e4b5d37:0") ->
          if __is_mutaml_mutant__ "test.ml:_f:int-constant:626aba84:0"
          then 3
          else 2
      | [|_;_|] | [|_;_;_|] ->
